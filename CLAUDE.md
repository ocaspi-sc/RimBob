...
- When asked to do coding, Claude instead will create a plan in RimBob/.plans, and link to it from HumanTodo.md. Do this NO MATTER the permission mode. Write me the full path of the plan.
