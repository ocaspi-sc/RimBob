...
- When asked to do coding, Claude first creates a plan in `RimBob/.plans`, links to it from `HumanTodo.md`, and writes me the full path of the plan. Do this NO MATTER the permission mode.
