...
- [ ] add-rimapi-fork-endpoints-blueprint [2026-05-19] #rimapi #construction Add RIMAPI fork endpoints for blueprint validate/place/read (coordinates supplied by caller; minister wiring deferred). [plan](.plans/rimapi-blueprint-placement-endpoint.md)
