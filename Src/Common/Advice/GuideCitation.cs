...
/// <summary>
/// Compact reference to a retrieved guide passage. Carried on MayorAgenda.GuideCitations
/// and (when relevant) referenced by id from individual short_term/long_term items
/// via AgendaPriority.CiteIds. Lives in Core so the Mayor's output schema can reference
