...
public static class SystemEndpoints
{
    ...
    [
        ...
        new("GET", "/api/v1/map/rooms?map_id", "active_read", "Willie/Welfare", "Room role, temperature, bed ids, roof/open-room signals, quality stats, and optional room footprints for placement reuse."),
        new("GET", "/api/v1/map/buildings?map_id", "active_read", "Willie/Chef", "Buildings, HP, power state, and working flags."),
        new("GET", "/api/v1/map/work-tables?map_id", "active_read", "Willie/Chef", "Work benches merged into the building registry so room anchors and kitchen bill reads see stoves, butcher spots, and research benches."),
    ...
    [
        ...
        new("GET", "/api/v1/map/region-at", "solver_client", "Willie Placement Solver", "Single-cell region id lookup used for room-anchor evidence and future region clustering; not part of periodic state refresh."),
