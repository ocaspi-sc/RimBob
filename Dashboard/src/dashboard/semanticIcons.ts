...
const common = {
  ...
  requests: emoji('📥', 'Requests icon'),
  rules: emoji('📏', 'Rules icon'),
  season: emoji('📅', 'Season icon'),
  solver: emoji('🧮', 'Solver icon'),
...
const fieldIcons: Record<string, SemanticIconSpec> = {
  ...
  logs: common.logs,
  barracks: item('Bed', 'Barracks icon', 'BA'),
  campfire: item('Campfire', 'Campfire icon', 'CF'),
  cooler: item('Cooler', 'Cooler icon', 'CO'),
  bed: item('Bed', 'Bed icon', 'BE'),
  freezer: item('Cooler', 'Freezer icon', 'FR'),
  meal_survival_pack: item('MealSurvivalPack', 'Packaged survival meal icon', 'MS'),
  stove: item('FueledStove', 'Stove icon', 'ST'),
  ...
  mark_hunt_area: item('Gun_Revolver', 'Hunt area action icon', 'HU'),
  ...
  unforbid: item('MealSurvivalPack', 'Unforbid action icon', 'UF'),
  unforbid_things: item('MealSurvivalPack', 'Unforbid things action icon', 'UF'),
  place_blueprint: item('Wall', 'Blueprint placement action icon', 'BP'),
  place_blueprint_group: item('Wall', 'Blueprint group placement icon', 'BP'),
  upsert_production_bill: common.kitchen,
  set_stockpile_zone: common.food,
  selected_rule: common.rules,
  placement_trace: common.construction,
  solver: common.solver,
