...
description: Close out a RimAI/Codex work session. Use when the user asks to wrap up, close out, end the session, review and commit session work, land the current slice on master, add follow-up todos, clean temporary artifacts, stop session-owned processes, or close a disposable worktree.
---
